...
%>
<h4 class="font-weight-bold mt-4">곡 정보</h4>
...
%>
		...
		<div class="ml-4">
			...
			<div class="d-flex mt-4">
				<div>
					<small class="d-block">앨범</small> <small class="d-block">재생시간</small>
					<small class="d-block">작곡가</small> <small class="d-block">작사가</small>
				</div>
				<div class="ml-5">
